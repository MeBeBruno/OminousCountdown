...
const startDatetime = new Date('2026-07-01T00:00:00').getTime();
const targetDatetime = new Date("2028-07-08T10:00:00").getTime();

setInterval(function() {
    let currentDatetime = new Date().getTime();
    let distance = targetDatetime - currentDatetime;

    let year = Math.floor(distance / (1000 * 60 * 60 * 24 * 365));
    ...
    countdown.innerText = year + ' y, ' + days + ':' + hours + ':' + minutes + ':' + seconds + ',' + milliseconds;
